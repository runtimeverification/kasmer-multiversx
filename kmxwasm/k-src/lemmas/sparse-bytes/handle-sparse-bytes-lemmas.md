...
module SPLIT-SPARSE-BYTES
    ...
    rule splitSparseBytes(
        ...
        => splitSparseBytes
            ( splitSparseBytesFunction(updateSparseBytes(F, SB, AddrF, WidthF), F, SB, Addr, AddrF, WidthF),
            Prefix, Addr
            )
